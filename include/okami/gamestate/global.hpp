...
const std::unordered_map<unsigned, const char *> brushUpgrades = {{0, "Power Slash 2"}, {6, "Cherry Bomb 2"}, {10, "Power Slash 3"}, {11, "Cherry Bomb 3"}};

const std::unordered_map<unsigned, const char *> areasRestored = {{1, "Kamiki Village"}, {2, "Hana Valley"},  {3, "Shinshu Field"},
                                                                  {4, "Tsuta Ruins"},    {5, "Agata Forest"}, {6, "Taka Pass"}};

const std::unordered_map<unsigned, const char *> commonStates = {{30, "All trees bloomed"}, {31, "Visited"}};

const std::unordered_map<unsigned, const char *> gameProgress = {{2, "Battle started after talking with merchant"},
...
const std::unordered_map<unsigned, const char *> keyItemsFound = {{0, "Charcoal"},        {1, "Blinding Snow"}, {2, "Treasure Box"},
                                                                  {4, "Herbal Medicine"}, {5, "Pinwheel"},      {6, "Marlin Rod"}};

const std::unordered_map<unsigned, const char *> goldDustsFound = {
    {0, "Agata Forest Merchant 1"},  {1, "Agata Forest Merchant 2"}, {2, "Kusa Village Merchant 1"}, {3, "Kusa Village Merchant 2"},
    {4, "Sei-an City Merchant 1"},   {5, "Sei-an City Merchant 2"},  {6, "Wep'keer Merchant 1"},     {7, "Wep'keer Merchant 2"},
    {8, "Ark of Yamato Merchant 1"}, {9, "Ark of Yamato Merchant 2"}};

const std::unordered_map<unsigned, const char *> animalsFound = {{1, "Hana Valley campfire - Monkey"},
...
const std::unordered_map<unsigned, const char *> globalGameState = {{1, "Scene border is up, in conversation"},
                                                                    {4, "Main menu open"},
