...
// Auto-generated from src/devtools/game-data/maps/AgataForestMadameFawnsHouse.yml
// Do not edit manually - regenerate with scripts/generate_gamestate_headers.py

namespace okami::game_state::maps::AgataForestMadameFawnsHouse
{
...
const std::unordered_map<unsigned, const char *> collectedObjects ={ { 0, "Chest (Stray Bead)" } };
