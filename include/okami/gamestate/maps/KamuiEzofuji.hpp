...
const std::unordered_map<unsigned, const char *> worldStateBits ={ { 3, "Take Lika to Ezofuji ended; Oki's Unauthorized Act started" }, { 6, "Oki's Unauthorized Act ended; Squatters of Ezofuji ended; Rising Yamato quest started" }, { 52, "Examined altar by entrance" } };
