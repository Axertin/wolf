...
const std::unordered_map<unsigned, const char *> worldStateBits = {{1, "Obtained Galestorm"},
...
const std::unordered_map<unsigned, const char *> collectedObjects = {{0, "Chest above staircase in top of windmill (Sun Fragment)"},
...
const std::unordered_map<unsigned, const char *> fightsCleared = {
    {0, "Started Chimaera Demon Gate"}, {1, "Blue Demon Scroll on 2nd floor"}, {2, "Defeated Chimaera Demon Gate"}};

const std::unordered_map<unsigned, const char *> npcs = {{0, "Yatsu"}};

const std::unordered_map<unsigned, const char *> mapsExplored = {
    {2, "Elevator area"}, {3, "Flame pillar room"}, {5, "Past Satomi Orbs gate"}, {6, "Kazegami hanging scrolls room"}};
