...
const std::unordered_map<unsigned, const char *> collectedObjects ={ { 18, "Clover on sapling ledge" }, { 42, "Bombed cracked rock on sapling ledge" }, { 43, "Bombed double-crack to cherry bomb 3 cave" } };
