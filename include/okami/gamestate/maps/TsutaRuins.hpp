...
const std::unordered_map<unsigned, const char *> worldStateBits = {{1, "Ball in greenway room de-petrified"},
...
const std::unordered_map<unsigned, const char *> collectedObjects = {{0, "Greenway room bulb lower level (Incense Burner)"},
...
const std::unordered_map<unsigned, const char *> areasRestored = {{16, "Hell gates room"},
...
const std::unordered_map<unsigned, const char *> cursedTreesBloomed = {{0, "Cursed tree by entrance right side bloomed"},
...
const std::unordered_map<unsigned, const char *> fightsCleared = {{1, "Gloomy room slip"}};
