...
// Auto-generated from src/devtools/game-data/maps/NRyoshimaCoastCherryBomb2Cave.yml
// Do not edit manually - regenerate with scripts/generate_gamestate_headers.py

namespace okami::game_state::maps::NRyoshimaCoastCherryBomb2Cave
{

const std::unordered_map<unsigned, const char *> worldStateBits = {{1, "Interacted with pool"}, {2, "Obtained Cherry Bomb 2"}};
...
const std::unordered_map<unsigned, const char *> collectedObjects = {
    {0, "Post-donation chest ([Cherry Bomb 2])"}, {1, "Clover middle"}, {2, "Clover right"}, {3, "Clover left"}};
