...
const std::unordered_map<unsigned, const char *> worldStateBits = {{1, "Hard Working Son quest ended"},
...
const std::unordered_map<unsigned, const char *> collectedObjects = {{1, "Chest on Cutters' house (Glass Beads)"},
...
const std::unordered_map<unsigned, const char *> areasRestored = {
    {16, "Mermaid spring"}, {17, "Bamboo field by entrance origin mirror"}, {18, "Bamboo field near Checkpoint exit"}, {31, "Taka Pass"}};

const std::unordered_map<unsigned, const char *> treesBloomed = {
    {0, "Path from sapling 1"},      {1, "Path from sapling 2"},         {2, "Path from sapling 3"},  {3, "Left of Checkpoint exit"},
    {4, "Right of Checkpoint exit"}, {5, "Behind right banner pole"},    {6, "Right of Sasa exit 1"}, {7, "Right of Sasa exit 2"},
    {8, "Right of Sasa exit 3"},     {9, "Just outside stray bead cave"}};

const std::unordered_map<unsigned, const char *> cursedTreesBloomed = {};

const std::unordered_map<unsigned, const char *> fightsCleared = {
    {9, "Mr and Mrs Cutter"}, {11, "Gate by mermaid spring"}, {12, "Gate in field by entrance origin mirror"}, {13, "Gate by Checkpoint exit"}};

const std::unordered_map<unsigned, const char *> npcs = {{0, "Mrs Cutter"}, {3, "Tea Master"}, {4, "Tea Customer"}, {5, "Sasa Traveler"}, {6, "Bingo"}};
