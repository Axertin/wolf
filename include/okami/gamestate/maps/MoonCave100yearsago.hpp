...
// Auto-generated from src/devtools/game-data/maps/MoonCave100yearsago.yml
// Do not edit manually - regenerate with scripts/generate_gamestate_headers.py

namespace okami::game_state::maps::MoonCave100yearsago
{

const std::unordered_map<unsigned, const char *> worldStateBits = {{1, "Enter Ishaku started"}};
