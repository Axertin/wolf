...
const std::unordered_map<unsigned, const char *> worldStateBits = {{1, "Entry dialogue trigger"},
...
const std::unordered_map<unsigned, const char *> collectedObjects = {{0, "4th chest on the left in Jumba's room (Vase)"},
