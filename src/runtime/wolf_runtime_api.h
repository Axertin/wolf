 ...
 */
void __cdecl wolfRuntimeFindPattern(const char *pattern, const char *mask, const char *module_name, 
                                   WolfPatternCallback callback, void *userdata);
 ...
 * @param userdata User-provided data
 */
typedef void(__cdecl *WolfMemoryWatchCallback)(uintptr_t address, const void *old_data, 
                                              const void *new_data, size_t size, void *userdata);
 ...
 * @return 1 on success, 0 on failure
 */
int __cdecl wolfRuntimeWatchMemory(WolfModId mod_id, uintptr_t start, size_t size, 
                                  WolfMemoryWatchCallback callback, void *userdata, const char *description);
 ...
 */
void __cdecl wolfRuntimeAddCommand(WolfModId mod_id, const char *name, WolfConsoleCommandCallback callback, 
 ...
 */
void __cdecl wolfRuntimeInterceptResource(WolfModId mod_id, const char *filename, 
                                         WolfResourceProvider provider, void *userdata);
 ...
 * @param userdata User data passed to provider
 */
void __cdecl wolfRuntimeInterceptResourcePattern(WolfModId mod_id, const char *pattern, 
                                                WolfResourceProvider provider, void *userdata);
...
// Forward declaration from wolf.hpp
